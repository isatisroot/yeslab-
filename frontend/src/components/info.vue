        ...
        <ul>
          ...
          <li @click="isactive= !isactive">
            ...
            <ul v-bind:class="{current:isactive}">
              <li @click.stop="">
                <router-link :to="'/info/reservation/?rack=1'"><span>Rack1</span></router-link>
              </li>
              <li @click.stop="">
                <router-link :to="'/info/reservation_2/?rack=2'"><span>Rack2</span></router-link>
              </li>
              <li @click.stop="">
                <router-link :to="'/info/reservation_3/?rack=3'"><span>Rack3</span></router-link>
              </li>
            </ul>
...
<style scoped>
  ...
  .el-aside {
    width: 300px;
    color: #f9f9f9;
    background: -webkit-linear-gradient(#bea4fb, #8e9cfa);
    /* Safari 5.1 - 6.0 */
    background: -o-linear-gradient(#bea4fb, #8e9cfa);
    /* Opera 11.1 - 12.0 */
    background: -moz-linear-gradient(#bea4fb, #8e9cfa);
    /* Firefox 3.6 - 15 */
    background: linear-gradient(#bea4fb, #8e9cfa);
    /* 标准的语法 */
  }
